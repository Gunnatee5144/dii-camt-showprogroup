...
=======
                      ...
                      <p className="text-slate-500 dark:text-slate-400 text-xs line-clamp-1 mb-4 font-normal">
                        {course.nameThai}
                      </p>

                      {/* Metadata: Intelligently using horizontal space */}
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 py-2.5 px-3 rounded-xl bg-slate-50/70 dark:bg-slate-900/60 border border-slate-100 dark:border-slate-800/70 text-xs text-slate-600 dark:text-slate-300 mb-4">
                        <div className="flex items-center gap-2 truncate">
                          <Users className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                          <span className="truncate" title={course.lecturerName || t.coursesPage.instructorTBA}>
                            {course.lecturerName || t.coursesPage.instructorTBA}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 truncate font-mono text-[11px]">
                          <Clock className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                          <span className="truncate" title={scheduleText}>{scheduleText}</span>
                        </div>
                        <div className="flex items-center gap-2 truncate font-mono text-[11px]">
