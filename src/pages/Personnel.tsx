    ...
    return (
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8 pb-10">
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                    { icon: GraduationCap, label: t.personnelPage.lecturers, value: String(mockLecturers.length), gradient: 'from-blue-500 to-indigo-500', shadow: 'shadow-blue-200' },
                    { icon: Briefcase, label: t.personnelPage.staffLabel, value: String(mockStaffUsers.length), gradient: 'from-emerald-500 to-teal-500', shadow: 'shadow-emerald-200' },
            ...
            <motion.div variants={itemVariants} className="bg-white/60 backdrop-blur-xl border border-white/60 rounded-2xl p-4 shadow-sm flex flex-col md:flex-row gap-3">
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="outline" className="rounded-xl">{t.personnelPage.printReport}</Button>
                </div>
            </motion.div>
