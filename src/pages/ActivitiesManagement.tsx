        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="relative w-full md:w-72">
                    ...
                    <Input placeholder={t.activitiesManagementPage.searchPlaceholder} className="pl-10 rounded-xl bg-white/80 border-slate-200 dark:border-slate-700 dark:bg-slate-900/50" />
                </motion.div>
            </div>
                ...
                <motion.div variants={itemVariants} className="lg:col-span-3 bg-white/60 backdrop-blur-xl border border-white/60 dark:border-slate-800/60 rounded-3xl p-6 shadow-sm dark:bg-slate-900/50">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <motion.div key={idx} whileHover={{ x: 4 }} className="p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white/80 hover:shadow-md transition-all dark:bg-slate-900/50">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button variant="outline" className="text-red-500 border-red-200 hover:bg-red-50 rounded-xl dark:text-slate-400 dark:bg-slate-800">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <motion.div key={idx} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 + idx * 0.1 }}
                                className="flex items-center justify-between p-3.5 rounded-2xl hover:bg-white transition-all dark:bg-slate-900">
                                ...
                                <Badge variant="outline" className={`rounded-xl text-xs ${act.status === 'completed' ? 'border-slate-200 text-slate-500 dark:text-slate-400 bg-slate-50' : 'border-emerald-200 text-emerald-600 bg-emerald-50'} dark:bg-slate-900/50`}>
