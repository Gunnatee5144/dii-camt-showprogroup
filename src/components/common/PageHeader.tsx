  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -right-1/4 w-96 h-96 bg-white/10 rounded-full blur-3xl dark:bg-slate-900/50" />
        <div className="absolute -bottom-1/2 -left-1/4 w-96 h-96 bg-white/5 rounded-full blur-3xl dark:bg-slate-900/50" />
        ...
        <div className="flex items-center gap-4">
          {icon && (
            <motion.div
              ...
              className="flex items-center justify-center w-14 h-14 rounded-xl bg-white/20 backdrop-blur-sm shadow-lg dark:bg-slate-900/50"
            >
