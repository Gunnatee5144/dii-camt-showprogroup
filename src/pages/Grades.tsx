...
export default function Grades() {
    ...
    return (
      ...
      >
        <ThemedPageHeader
          ...
          subtitle={`ภาคเรียนที่ ${mockStudent.semester}/${mockStudent.academicYear}`}
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <motion.div
            ...
            className={`relative overflow-hidden rounded-2xl p-6 text-white shadow-xl ${
              mockStudent.academicStatus === 'normal' 
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl text-2xl font-bold text-white shadow-lg ${
                            grade.letterGrade === 'A' ? 'bg-gradient-to-br from-green-500 to-emerald-500 shadow-green-200' :
  ...
  return (
    ...
    >
      <ThemedPageHeader
        title="จัดการเกรด"
        subtitle="สำหรับอาจารย์และเจ้าหน้าที่"
        icon={<GraduationCap className="w-7 h-7" />}
      />
      <ThemedCard variant="elevated">
        <CardHeader>
          ...
          <CardDescription>ระบบจัดการเกรดสำหรับอาจารย์และเจ้าหน้าท้ี่</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">ระบบจัดการเกรดสำหรับอาจารย์</p>
        </CardContent>
      </ThemedCard>
    </motion.div>
  );
