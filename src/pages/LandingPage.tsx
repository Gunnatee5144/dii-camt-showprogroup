...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden font-sans text-slate-900">
        ...
        <div className={`pointer-events-auto mx-auto max-w-6xl flex items-center justify-between transition-all duration-700 ${
          ...
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <div className={`flex flex-col transition-opacity duration-300 ${scrolled ? 'scale-90 transform-origin-left' : ''}`}>
              <div className="font-extrabold text-xl tracking-tight text-slate-900 leading-none">DII CAMT</div>
              <div className="text-[10px] text-slate-500 font-bold tracking-[0.1em] uppercase mt-0.5">Integration</div>
            </div>
          </div>

          {/* Desktop Navigation Links */}
          <div className="hidden md:flex items-center gap-1 bg-slate-50/50 backdrop-blur-sm px-2 py-1.5 rounded-full border border-slate-200/50 shadow-inner">
            <a href="#features" className="px-4 py-1.5 rounded-full text-sm font-bold text-slate-600 hover:text-blue-700 hover:bg-white hover:shadow-sm transition-all">{t.landing.navFeatures}</a>
            <a href="#stats" className="px-4 py-1.5 rounded-full text-sm font-bold text-slate-600 hover:text-blue-700 hover:bg-white hover:shadow-sm transition-all">{t.landing.navStats}</a>
            <a href="#partners" className="px-4 py-1.5 rounded-full text-sm font-bold text-slate-600 hover:text-blue-700 hover:bg-white hover:shadow-sm transition-all">{t.landing.navPartners}</a>
            <a href="#contact" className="px-4 py-1.5 rounded-full text-sm font-bold text-slate-600 hover:text-blue-700 hover:bg-white hover:shadow-sm transition-all">{t.landing.navContact}</a>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Button 
              ...
              className="hidden sm:flex h-10 px-4 rounded-full bg-slate-50 hover:bg-white border border-slate-200/60 shadow-sm font-bold text-slate-600 hover:text-blue-600 transition-all gap-2"
            >
            ...
            <div className="flex items-center gap-2 pl-2 sm:border-l border-slate-200">
              <Link to="/login" className="hidden sm:block">
                <Button variant="ghost" className="h-10 px-5 rounded-full font-bold text-slate-700 hover:bg-slate-50 transition-all">
                  {t.landing.login}
                </Button>
              </Link>
              <Link to="/register">
      ...
      <section className="relative min-h-[95vh] flex items-center pt-24 pb-32 overflow-hidden bg-slate-50 selection:bg-blue-200/50 font-sans">
        ...
        <div className="container mx-auto px-6 relative z-10 w-full mt-10">
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-6 text-left w-full max-w-2xl mx-auto lg:mx-0 relative">
              ...
              {/* Refined Badge */}
              <FadeIn delay={0.1}>
                <div className="inline-flex items-center gap-3 mb-8 px-5 py-2.5 rounded-full bg-white/60 border border-slate-200/60 backdrop-blur-xl shadow-sm hover:bg-white/80 transition-colors">
                  <div className="relative flex h-2.5 w-2.5">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-blue-500"></span>
                  </div>
                  <span className="text-xs sm:text-sm font-semibold text-slate-700 tracking-wider uppercase">
                    {language === 'th' ? 'แพลตฟอร์มบูรณาการวิชาการ' : 'Academic Integration Platform'}
                  </span>
                </div>
              </FadeIn>
              ...
              {/* Elegant Headline */}
              <FadeIn delay={0.2}>
                <h1 className="text-5xl md:text-6xl lg:text-[4.8rem] font-bold tracking-tight text-slate-900 mb-6 leading-[1.1] font-sans">
                  <span className="text-slate-800">{language === 'th' ? 'การศึกษาที่' : 'Empowering'}</span><br/>
              ...
              {/* Crisp Description */}
              <FadeIn delay={0.3}>
                <p className="text-lg md:text-xl text-slate-600 mb-10 leading-relaxed font-light max-w-lg border-l-2 border-indigo-200 pl-6">
                  {language === 'th' 
              ...
              <FadeIn delay={0.4}>
                <div className="flex flex-col sm:flex-row items-center sm:items-stretch gap-4">
                  ...
                  <Link to="/features" className="w-full sm:w-auto">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 text-slate-700 border-slate-200 hover:bg-slate-100/50 rounded-full text-base font-medium transition-all group bg-white/50 backdrop-blur-sm">
                      <div className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center mr-3 group-hover:bg-blue-100 group-hover:scale-110 transition-transform">
            ...
            <div className="lg:col-span-6 relative w-full h-[650px] hidden lg:flex items-center justify-center perspective-[2500px]">
              ...
              <FadeIn delay={0.6} className="absolute z-30">
                <motion.div 
                  ...
                  className="w-[480px] h-[340px] rounded-3xl bg-white/70 border border-white backdrop-blur-2xl p-1 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] overflow-hidden relative group"
                >
                  ...
                  {/* MacOS Style Top Bar */}
                  <div className="h-10 bg-white/40 border-b border-slate-100 flex items-center px-4 gap-2 relative z-10">
                    <div className="flex gap-1.5">
                      <div className="w-3 h-3 rounded-full bg-red-400"></div>
                      <div className="w-3 h-3 rounded-full bg-amber-400"></div>
                      <div className="w-3 h-3 rounded-full bg-emerald-400"></div>
                    </div>
                    <div className="mx-auto flex items-center justify-center gap-2 w-48 h-6 bg-white/60 rounded-md border border-slate-100 text-[10px] text-slate-500 font-medium">
                  ...
                  <div className="p-5 flex gap-5 relative z-10">
                    ...
                    <div className="w-16 space-y-3">
                      {[1, 2, 3, 4].map(i => (
                        <motion.div 
                          ...
                          className={`w-10 h-10 rounded-xl flex items-center justify-center cursor-pointer transition-colors ${i === 1 ? 'bg-blue-100 border border-blue-200 text-blue-600 shadow-sm' : 'bg-white border border-slate-100 text-slate-400 hover:bg-slate-50'}`}
                        >
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="h-28 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 border border-blue-500/20 p-5 relative overflow-hidden flex flex-col justify-end shadow-md">
                        <div className="absolute right-[-10%] top-[-20%] w-32 h-32 bg-white/20 blur-2xl rounded-full"></div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="h-20 rounded-2xl bg-white border border-slate-100 p-3 shadow-sm hover:shadow-md transition-shadow">
                          <div className="w-7 h-7 rounded-full bg-purple-100 flex items-center justify-center mb-2">
              ...
              <FadeIn delay={1.0} className="absolute z-40 top-[15%] right-[5%]">
                <motion.div
                  ...
                  className="px-4 py-3 rounded-2xl bg-white/90 border border-slate-200 backdrop-blur-xl shadow-xl flex items-center gap-3"
                >
                  ...
                  <div>
                    <div className="text-xs font-bold text-slate-800 uppercase tracking-wider">{language === 'th' ? 'AI วิเคราะห์' : 'AI Analysis'}</div>
                    <div className="text-[10px] text-slate-500">Processing skills...</div>
                  </div>
                </motion.div>
              </FadeIn>
              ...
              <FadeIn delay={1.2} className="absolute z-20 bottom-[10%] left-[5%]">
                <motion.div
                  ...
                  className="w-48 p-4 rounded-3xl bg-white/80 border border-slate-100 backdrop-blur-xl shadow-xl"
                >
      ...
      <section id="features" className="py-40 bg-[#f8fafc] relative overflow-hidden font-sans border-t border-slate-100">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-24 gap-12">
            <FadeIn className="max-w-3xl">
              <div className="mb-8 flex items-center gap-4">
                ...
                <span className="text-blue-600 font-bold tracking-[0.3em] text-xs uppercase bg-blue-50 px-4 py-1.5 rounded-full border border-blue-100/50">Next-Gen Architecture</span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-6 lg:gap-8">
            ...
            <FadeIn delay={0.1} className="md:col-span-2 h-full rounded-[2.5rem] bg-white/60 backdrop-blur-3xl border border-white/80 overflow-hidden relative group shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_40px_100px_-20px_rgba(59,130,246,0.15)] hover:-translate-y-2 transition-all duration-700 flex flex-col p-10">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-slate-900 mb-3 tracking-tight drop-shadow-sm">{t.landing.forStudents}</h3>
                  <p className="text-slate-500 text-sm leading-relaxed font-light">{t.landing.forStudentsDesc}</p>
                </div>

                <div className="mt-10 relative h-40 w-[110%] -ml-2 rounded-[2rem] bg-slate-50/80 backdrop-blur-md border border-white/60 shadow-[inset_0_2px_20px_rgba(255,255,255,1),0_10px_40px_rgba(0,0,0,0.05)] overflow-hidden group-hover:-translate-y-2 transition-transform duration-700 flex items-end">
            ...
            <FadeIn delay={0.3} className="md:col-span-2 h-full rounded-[2.5rem] bg-gradient-to-br from-emerald-50/80 to-white/80 backdrop-blur-xl border border-emerald-100/60 overflow-hidden relative group hover:border-emerald-200 hover:shadow-[0_40px_80px_-20px_rgba(16,185,129,0.15)] hover:-translate-y-2 transition-all duration-700 p-10 flex flex-col">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                <div>
                  <div className="w-16 h-16 rounded-[1.25rem] bg-white border border-emerald-100 text-emerald-500 flex items-center justify-center shadow-md shadow-emerald-100/50 mb-8 group-hover:rotate-6 transition-transform">
                    <BookOpen className="w-8 h-8" />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900 mb-3 tracking-tight">{t.landing.forLecturers}</h3>
                  <p className="text-slate-600 text-sm leading-relaxed font-light">{t.landing.forLecturersDesc}</p>
                </div>
                
                <div className="mt-10 space-y-3 w-full relative z-10">
                  <div className="h-12 w-full rounded-2xl bg-white/60 backdrop-blur-md border border-emerald-50 shadow-sm flex items-center px-4 gap-3 group-hover:translate-x-2 transition-transform delay-75">
                     <div className="w-2 h-2 rounded-full bg-emerald-400"></div>
                     <div className="h-2 w-16 bg-slate-200 rounded-full"></div>
                  </div>
                  <div className="h-12 w-full rounded-2xl bg-white/60 backdrop-blur-md border border-emerald-50 shadow-sm flex items-center px-4 gap-3 group-hover:translate-x-2 transition-transform delay-150">
                     <div className="w-2 h-2 rounded-full bg-emerald-400"></div>
            ...
            <FadeIn delay={0.4} className="md:col-span-3 h-full rounded-[2.5rem] bg-white/60 backdrop-blur-3xl border border-white/80 overflow-hidden relative group shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.06)] hover:-translate-y-2 transition-all duration-700 p-10 flex flex-col md:flex-row items-center gap-10">
               ...
               <div className="flex-1 relative z-10">
                 <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="px-4 py-1.5 rounded-full bg-purple-50 text-purple-700 text-xs font-bold uppercase tracking-wider border border-purple-100/50">Real-time Sync</span>
                 </div>
                 <h3 className="text-3xl font-bold text-slate-900 mb-3 tracking-tight">{t.landing.fastProcessing}</h3>
                 <p className="text-slate-500 text-sm leading-relaxed font-light">{t.landing.fastProcessingDesc}</p>
               </div>
            ...
            <FadeIn delay={0.5} className="md:col-span-3 h-full rounded-[2.5rem] bg-white/60 backdrop-blur-xl border border-amber-100/50 overflow-hidden relative group shadow-[0_4px_24px_rgba(0,0,0,0.02)] hover:shadow-[0_40px_80px_-20px_rgba(245,158,11,0.15)] hover:-translate-y-2 transition-all duration-700 p-10 flex flex-col justify-between">
               ...
               <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-slate-900 mb-3 tracking-tight">{t.landing.forIndustry}</h3>
                    <p className="text-slate-500 text-sm leading-relaxed font-light md:w-3/4">{t.landing.forIndustryDesc}</p>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-20 relative">
            ...
            {[
              ...
              <FadeIn key={i} delay={i * 0.15} className="relative flex flex-col items-center text-center group cursor-default">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-white/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                ...
                <div className="relative z-10">
                  ...
                  {/* Animated micro-line */}
                  <div className="h-[2px] w-8 bg-white/10 mx-auto mb-6 group-hover:w-full transition-all duration-700 ease-out overflow-hidden relative">
                     <div className="absolute inset-0 bg-white/40 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-700 delay-100 ease-out"></div>
                  </div>
      ...
      <section id="partners" className="py-40 bg-white relative overflow-hidden font-sans">
        <div className="container mx-auto px-6 relative z-10">
          
          <div className="text-center mb-20">
            <FadeIn>
              <div className="text-[10px] font-bold tracking-[0.3em] text-slate-400 uppercase mb-4">Recognized Globally</div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Trusted by pioneers.</h2>
            </FadeIn>
          </div>
                ...
                {[...Array(2)].map((_, setIdx) => (
                  <React.Fragment key={setIdx}>
                    {[
                      ...
                      <div key={`${setIdx}-${i}`} className={`text-2xl md:text-3xl font-bold text-slate-800 cursor-default hover:text-blue-600 transition-colors ${partner.font}`}>
                        {partner.logo}
                      </div>
                    ))}
                  </React.Fragment>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-0 relative">
              ...
              <FadeIn delay={0.2} className="w-full lg:w-5/12 relative z-20">
                <div className="aspect-[3/4] w-full max-w-md mx-auto lg:mx-0 rounded-[2rem] bg-slate-100 relative overflow-hidden group">
                  ...
                  <div className="w-full h-full bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-slate-200 via-slate-300 to-slate-400 flex items-center justify-center transition-transform duration-1000 group-hover:scale-105">
                    <div className="w-32 h-32 rounded-full border border-slate-400/30 flex items-center justify-center backdrop-blur-sm">
                      <span className="text-slate-500/50 font-light tracking-widest text-xs uppercase -rotate-45">Portrait</span>
                    </div>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.3} className="w-full lg:w-8/12 lg:-ml-20 relative z-30">
                <div className="bg-white/80 backdrop-blur-2xl p-10 md:p-16 lg:p-20 rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] border border-slate-100/60 lg:translate-y-12">
                  <div className="mb-10 text-blue-600/20">
                  ...
                  <blockquote className="text-2xl md:text-4xl font-light leading-[1.3] text-slate-900 tracking-tight mb-12">
                    {t.landing.testimonialQuote}
                  </blockquote>
                  <div className="flex items-center gap-6">
                    <div className="h-px w-16 bg-slate-200"></div>
                    <div>
                      <div className="font-bold tracking-tight text-slate-900 text-lg">{t.landing.testimonialName}</div>
                      <div className="text-slate-500 font-medium text-sm">{t.landing.testimonialRole}</div>
                    </div>
                  </div>
                </div>
              </FadeIn>
      ...
      <section id="contact" className="py-32 md:py-48 relative bg-white overflow-hidden font-sans border-t border-slate-100/50">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="max-w-2xl">
              <FadeIn>
                <div className="inline-flex items-center gap-3 mb-8">
                  ...
                  <span className="text-blue-600 font-bold text-xs uppercase tracking-[0.2em]">Start Your Journey</span>
                </div>
                <h2 className="text-5xl md:text-7xl font-bold text-slate-900 tracking-tighter mb-8 leading-[1.1]">
                ...
                <div className="flex flex-col sm:flex-row gap-5">
                  ...
                  <Link to="/contact" className="group">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto h-16 px-10 bg-white border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 rounded-[2rem] text-lg font-bold tracking-tight transition-all duration-300">
                      {t.landing.contactUs}
                    </Button>
                  </Link>
                </div>
            ...
            <div className="relative">
              <FadeIn delay={0.2} className="relative z-10">
                <div className="aspect-[4/3] rounded-[3rem] bg-white/60 backdrop-blur-3xl border border-white shadow-[0_40px_100px_-20px_rgba(0,0,0,0.05),inset_0_2px_20px_rgba(255,255,255,1)] p-10 flex flex-col justify-between overflow-hidden group">
                  {/* Internal Glow */}
                  ...
                  <div className="relative z-10 flex justify-between items-start">
                    ...
                    <div className="flex -space-x-4">
                      <div className="w-12 h-12 rounded-full border-2 border-white bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-400">P1</div>
                      <div className="w-12 h-12 rounded-full border-2 border-white bg-slate-200 flex items-center justify-center text-xs font-bold text-slate-500">P2</div>
                      <div className="w-12 h-12 rounded-full border-2 border-white bg-slate-300 flex items-center justify-center text-xs font-bold text-slate-600">P3</div>
                    </div>
                  </div>

                  <div className="relative z-10 mt-12 grid grid-cols-2 gap-4">
                    <div className="bg-white/80 rounded-2xl p-6 border border-white shadow-sm hover:border-blue-100 transition-colors">
                      <div className="text-3xl font-bold text-slate-900 mb-1">24/7</div>
                      <div className="text-sm font-medium text-slate-500">Platform Access</div>
                    </div>
                    <div className="bg-white/80 rounded-2xl p-6 border border-white shadow-sm hover:border-indigo-100 transition-colors">
                      <div className="text-3xl font-bold text-slate-900 mb-1">100%</div>
                      <div className="text-sm font-medium text-slate-500">Secure Data</div>
                    </div>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.4} className="absolute -bottom-10 -left-10 z-0">
                 <div className="w-48 h-48 rounded-[2.5rem] bg-gradient-to-tr from-slate-50 to-white border border-white shadow-[0_20px_40px_-10px_rgba(0,0,0,0.05)] rotate-12 flex items-center justify-center">
                    <div className="w-24 h-24 rounded-full border-8 border-slate-100/50"></div>
                 </div>
              </FadeIn>
            </div>
      ...
      {/* Footer */}
      <footer className="relative bg-white pt-24 pb-10 border-t border-slate-100 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-50/50 to-white pointer-events-none" />
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-blue-50 rounded-full blur-[100px] opacity-70 pointer-events-none" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-xl text-slate-900 tracking-tight">DII CAMT</span>
                  <span className="text-[10px] uppercase font-bold text-blue-600 tracking-wider">Digital Industry</span>
                </div>
              </div>
            ...
            <div>
              <h4 className="font-bold text-slate-900 mb-6 uppercase tracking-wider text-sm">{t.landing.mainMenu}</h4>
              <ul className="space-y-4 text-slate-500 font-medium text-sm">
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.home}</a></li>
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.aboutUs}</a></li>
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.curriculum}</a></li>
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.news}</a></li>
              </ul>
            </div>

            <div>
              <h4 className="font-bold text-slate-900 mb-6 uppercase tracking-wider text-sm">{t.landing.forUsers}</h4>
              <ul className="space-y-4 text-slate-500 font-medium text-sm">
                <li><Link to="/login" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.login}</Link></li>
                <li><Link to="/register" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.register}</Link></li>
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.userGuide}</a></li>
                <li><a href="#" className="hover:text-blue-600 hover:translate-x-1 inline-block transition-all focus:outline-none">{t.landing.reportIssue}</a></li>
              </ul>
            </div>

            <div>
              <h4 className="font-bold text-slate-900 mb-6 uppercase tracking-wider text-sm">{t.landing.footerContact}</h4>
              <ul className="space-y-4 text-slate-500 font-medium text-sm">
                <li className="flex items-center gap-3 hover:text-blue-600 transition-colors cursor-pointer p-2 rounded-lg hover:bg-blue-50/50 -ml-2">
          ...
          <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-medium text-slate-400">
